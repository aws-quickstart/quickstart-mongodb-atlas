//TODO this needs revision. Talk about the two options: (defaut? or without peering) Atlas and Atlas with VPC peering. For the VPC peering option, the user has the option of deploying in a new or existing VPC
